...
const structuralSignals = [
  ...
  { path: "agent/entry.json", points: 5, label: "Public agent entry" },
  { path: "agent/packs/starter.json", points: 3, label: "Zero-clone starter pack" },
  { path: "agent/schema/entry.schema.json", points: 2, label: "Public entry contract" },
  ...
  { path: "gym/agents/manifest.json", points: 3, label: "Web-coder contract" },
  { path: "integrations/mcp/README.md", points: 2, label: "Optional MCP adapter" },
  { path: "SECURITY.md", points: 2, label: "Security policy" },
